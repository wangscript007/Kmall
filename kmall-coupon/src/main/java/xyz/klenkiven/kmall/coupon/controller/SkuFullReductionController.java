...
public class SkuFullReductionController {
     ...
     */
    @PostMapping("/save/all-reduction")
    public R saveAllReduction(@RequestBody SkuReductionTO skuReductionTO) {
        skuFullReductionService.saveAllReduction(skuReductionTO);
